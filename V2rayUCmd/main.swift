...
class V2rayUCmd: NSObject {
    ...
    static func setProxy(mode: RunMode, pacUrl: String, httpPort: String, sockPort: String) {
        ...
        // set system proxy
        let prefRef = SCPreferencesCreateWithAuthorization(kCFAllocatorDefault, "systemProxySet" as CFString, nil, authRef)!
...
// authRef
let error = AuthorizationCreate(nil, nil, [.interactionAllowed,.extendRights,.partialRights,.destroyRights,.preAuthorize], &authRef)

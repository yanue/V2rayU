...
final class AppSettings: ObservableObject {
    ...
    @Published var statusBarRefreshInterval: Int = UserDefaults.getInt(forKey: .statusBarRefreshInterval, defaultValue: 1)
    ...
    func reload() {
        ...
        statusBarRefreshInterval = UserDefaults.getInt(forKey: .statusBarRefreshInterval, defaultValue: 1)
    ...
    func _save() {
        ...
        UserDefaults.setInt(forKey: .statusBarRefreshInterval, value: statusBarRefreshInterval)

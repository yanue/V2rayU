...
class ConfigWindowController: NSWindowController, NSWindowDelegate, NSTabViewDelegate {
    ...
    @IBOutlet weak var grpcUseragent: NSPopUpButton!
    ...
    func exportData() {
        ...
        v2rayConfig.streamGrpc.multi = self.grpcMulti.boolValue
    ...
    func bindDataToView() {
        ...
        self.grpcMulti.intValue = v2rayConfig.streamGrpc.multi ? 1 : 0
